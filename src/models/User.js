...
const userSchema = new mongoose.Schema({
  ...
  paymentClientTxnId: { type: String, default: '', trim: true, index: true },
  paymentGatewayStatus: { type: String, default: '', trim: true },
  paymentGatewayResponse: { type: mongoose.Schema.Types.Mixed, default: undefined },
